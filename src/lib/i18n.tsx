...
const translations = {
  fr: {
    ...
    // Voice AI
    voiceTitle: 'Créer un devis',
    voiceSubtitle: 'Décrivez les travaux à la voix, l\'IA prépare le devis pour vous',
    ...
    comparatifDesc: 'Comparer les 3 gammes côte à côte',
    comparatifTitle: 'Comparatif des 3 gammes',
    designation: 'Désignation',
    sendToClient: 'Envoyer au client',
    signNow: 'Signer maintenant',
    chooseGamme: 'Choisissez la gamme finale',
  ...
  en: {
    ...
    comparatif: 'Compare',
    comparatifDesc: 'Compare all 3 ranges side by side',
    comparatifTitle: 'Comparison of 3 ranges',
    designation: 'Designation',
    sendToClient: 'Send to client',
    signNow: 'Sign now',
    chooseGamme: 'Choose the final range',
